...
import io.cdap.cdap.internal.tether.TetherClientModule;
import io.cdap.cdap.internal.tether.TetherServerHandler;
import io.cdap.cdap.internal.tether.TetherServerModule;
...
public final class AppFabricServiceRuntimeModule extends RuntimeModule {
  ...
  public Module getDistributedModules() {
    ...
    return Modules.combine(new AppFabricServiceModule(ImpersonationHandler.class),
                           ...
                           new EntityVerifierModule(),
                           new ProvisionerModule(),
                           new TetherServerModule(),
                           new TetherClientModule(),
                           BootstrapModules.getFileBasedModule(),
                           new AbstractModule() {
                             @Override
                             protected void configure() {
