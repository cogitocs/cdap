...
public class BatchSQLRelationalEngine implements SparkRelationalEngine {
  ...
  public BatchSQLRelationalEngine(JavaSparkExecutionContext sec,
  ...
  public Engine getRelationalEngine() {
    return adapter.getRelationalEngine();
  }
